...
\begin{frame}[label={sec:orgfca4ebd}]{Example}
\begin{center}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org0e0ae95}]{Applications}
\begin{itemize}
...
\begin{frame}[label={sec:org6fa3d3f}]{Unmixing processing chain}
\begin{enumerate}
...
\label{sec:org60643ad}
\subsection{Linear models}
\label{sec:orgb5ce033}
\begin{frame}[label={sec:orgbbea288}]{Linear mixture model}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org12110af}]{Geometric viewpoint}
\begin{itemize}
...
\label{sec:orga4c378c}
\begin{frame}[label={sec:org5e40113}]{Bilinear models}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgca2e48b}]{Other models}
\begin{itemize}
...
\label{sec:orgaface66}
\subsection{Subspace extraction}
\label{sec:org7bc3bea}
\begin{frame}[label={sec:org4fca11f}]{Conventional methods}
...
\label{sec:orgedbdb3c}
\begin{frame}[label={sec:org13d9da6}]{Pixel Purity Index \cite{Boardman1995}}
\begin{enumerate}
\item Apply MNF
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6b5999d}]{N-FINDR \cite{findr}}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orge5fd755}]{Vertex component analysis \cite{1411995}}
\begin{itemize}
...
\label{sec:org4bf73fd}
\begin{frame}[label={sec:orgc008c3b}]{Moffett data}
\begin{center}
\includegraphics[width=0.7\textwidth]{./figures/moffett.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb7ef9fd}]{Endmember extraction}
\begin{center}
\begin{tikzpicture}
...
\label{sec:org19f16e8}
\subsection{Abundance estimation}
\label{sec:org48867f4}
\begin{frame}[label={sec:orgcd016a4}]{Unconstrained least squares}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org635797e}]{Constrainted least squares}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:org5eba35a}]{NNLS}
...
\begin{frame}[fragile,label={sec:org8fb0370}]{FCLS 1/2}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
from scipy import optimize
import scipy as sp
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgd760d22}]{FCLS 2/2}
\begin{center}
\begin{tikzpicture}
\begin{axis}[xmin=450,xmax=2500,ymin=0,ymax=1,grid,xlabel=$\lambda~({\mu}m)$,ylabel=Reflectance,width=\linewidth,height=0.9\textheight]
  \addplot+[mark=none,smooth,thick] table[x index=0,y index=1,col sep = comma, restrict x to domain=410:1802,forget plot] {figures/endmembers.csv};
...
\end{center}
\end{frame}
\begin{frame}[fragile,label={sec:orgf6ddae0}]{Abundance maps 1/4}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
from scipy import optimize
import scipy as sp
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orga5a32a2}]{Abundances 2/4}
\begin{center}
\includegraphics[width=0.7\textwidth]{./figures/abundances_baresoil.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd8b9b0f}]{Abundances 3/4}
\begin{center}
\includegraphics[width=0.7\textwidth]{./figures/abundances_water.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2bdf866}]{Abundances 4/4}
\begin{center}
