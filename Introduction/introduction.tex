...
\label{sec:org7bd4f50}
\begin{frame}[label={sec:org8aeace8}]{Remote sensing}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[fragile,label={sec:orge910115}]{Fields of application}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4a95915}]{Hekla Volcano, Iceland}
\begin{columns}
...
\label{sec:orgb40c188}
\subsection{Element of physics}
\label{sec:orgbdc7913}
\begin{frame}[label={sec:org1d8cb1b}]{Electromagnetic wave}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1cc9ff0}]{Electromagnetic spectrum}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgdb335d6}]{Spectral reflectance}
\alert{Reflectance}: 
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga3b99e5}]{Spectral reflectance curves}
...
\label{sec:orgbacae75}
\begin{frame}[label={sec:orgfbb60a8}]{Remote sensing images}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org16e3762}]{Multispectral versus hyperspectral}
\begin{center}
\begin{tikzpicture}[]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org89e0878}]{Hyperspectral sensors}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:org12c09fb}
\begin{frame}[label={sec:org80bdd80}]{Vegetation 1/2}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf345344}]{Vegetation 2/2}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf7bf4f3}]{Water}
\begin{center}
  \begin{tikzpicture}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga2c8d8f}]{Human made materials}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:orgbdd33a6}
\subsection{What is remote sensing made of ?}
\label{sec:org2487b88}
\begin{frame}[label={sec:orgcaf6a57}]{An interdisciplinary field}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfcc2935}]{Processing chain}
...
\begin{frame}[label={sec:org924a2f3}]{Hot topics}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:orgae0fe05}
\begin{frame}[label={sec:org050ae68}]{Challenges}
\begin{itemize}
...
\begin{frame}[label={sec:org2d676c0}]{Spectral variability}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:org2a487c9}
\begin{frame}[label={sec:orge221b7d}]{Properties of HD spaces 1/3}
\begin{itemize}
...
\begin{frame}[label={sec:org603bd26}]{Properties of HD spaces 2/3}
Consider                                                             a
...
\begin{frame}[label={sec:orgb9c7f4e}]{Properties of HD spaces 3/3}
\begin{itemize}
...
\begin{frame}[label={sec:org3ca8d90}]{Consequences for the analysis}
\begin{itemize}
...
\end{frame}
\section{Questions}
\label{sec:org5f5d62e}
\begin{frame}[label={sec:org996bea6}]{Is there a fake ?}
\begin{onlyenv}<1>
\begin{center}
...
\begin{frame}[label={sec:org4163a37}]{Spectra}
...
\begin{frame}[label={sec:orga5de41a}]{Gaussian distribution}
