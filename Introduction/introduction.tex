...
\label{sec:orged475bc}
\begin{frame}[label={sec:org70bcf6f}]{Remote sensing}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[fragile,label={sec:org77a89d7}]{Fields of application}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org0ea3755}]{Hekla Volcano, Iceland}
\begin{columns}
...
\label{sec:org699efba}
\subsection{Element of physics}
\label{sec:org80ad24c}
\begin{frame}[label={sec:org56dfdc4}]{Electromagnetic wave}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org0ba0602}]{Electromagnetic spectrum}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgdfbf913}]{Spectral reflectance}
\alert{Reflectance}: 
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5c4744c}]{Spectral reflectance curves}
...
\label{sec:orgbb73aea}
\begin{frame}[label={sec:org0f9aa03}]{Remote sensing images}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org40ee4bb}]{Multispectral versus hyperspectral}
\begin{center}
\begin{tikzpicture}[]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd79589c}]{Hyperspectral sensors}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:org52a91d1}
\begin{frame}[label={sec:org1e1bfb3}]{Vegetation 1/2}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org048c017}]{Vegetation 2/2}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfb57782}]{Water}
\begin{center}
  \begin{tikzpicture}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org17a56d8}]{Human made materials}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:orgee1b1f6}
\subsection{What is remote sensing made of ?}
\label{sec:org16913a6}
\begin{frame}[label={sec:orgfe43285}]{An interdisciplinary field}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd39d455}]{Processing chain}
...
\begin{frame}[label={sec:org13c8377}]{Hot topics}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:orgade0609}
\begin{frame}[label={sec:org8565c00}]{Challenges}
\begin{itemize}
...
\begin{frame}[label={sec:org1f7f6ef}]{Spectral variability}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:org30be812}
\begin{frame}[label={sec:org39ee5f3}]{Properties of HD spaces 1/3}
\begin{itemize}
...
\begin{frame}[label={sec:orgc4c7e73}]{Properties of HD spaces 2/3}
Consider                                                             a
...
\begin{frame}[label={sec:org76f7bef}]{Properties of HD spaces 3/3}
\begin{itemize}
...
\begin{frame}[label={sec:orga9d868f}]{Consequences for the analysis}
\begin{itemize}
...
\end{frame}
\section{Questions}
\label{sec:org87856ac}
\begin{frame}[label={sec:org4f480de}]{Is there a fake ?}
\begin{onlyenv}<1>
\begin{center}
...
\begin{frame}[label={sec:org73f916a}]{Spectra}
...
\begin{frame}[label={sec:org5560f7c}]{Gaussian distribution}
