...
\label{sec:org3b19bac}
\begin{frame}[label={sec:org2585f6d}]{Remote sensing}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[fragile,label={sec:orgabd1371}]{Fields of application}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc2a0588}]{Hekla Volcano, Iceland}
\begin{columns}
...
\label{sec:orgfeab3a5}
\subsection{Element of physics}
\label{sec:org2aafa12}
\begin{frame}[label={sec:orgc3b45d4}]{Electromagnetic wave}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org3614284}]{Electromagnetic spectrum}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgb12dd05}]{Spectral reflectance}
\alert{Reflectance}: 
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org43d5dd9}]{Spectral reflectance curves}
...
\label{sec:org461de43}
\begin{frame}[label={sec:org1660bde}]{Remote sensing images}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf2356a5}]{Multispectral versus hyperspectral}
\begin{center}
\begin{tikzpicture}[]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org2e3a803}]{Hyperspectral sensors}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:orgbfa5589}
\begin{frame}[label={sec:orgf412f93}]{Vegetation 1/2}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd20339d}]{Vegetation 2/2}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge62f78a}]{Water}
\begin{center}
  \begin{tikzpicture}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1bb2ecf}]{Human made materials}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:orgfdb4a82}
\subsection{What is remote sensing made of ?}
\label{sec:org0c0a8b8}
\begin{frame}[label={sec:orgf98e6a8}]{An interdisciplinary field}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb402063}]{Processing chain}
...
\begin{frame}[label={sec:orge4d3078}]{Hot topics}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:org29e7aad}
\begin{frame}[label={sec:org33b16dc}]{Challenges}
\begin{itemize}
...
\begin{frame}[label={sec:orga5bc28b}]{Spectral variability}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:org5e03fad}
\begin{frame}[label={sec:org1c49d1d}]{Properties of HD spaces 1/3}
\begin{itemize}
...
\begin{frame}[label={sec:org8ebff66}]{Properties of HD spaces 2/3}
Consider                                                             a
...
\begin{frame}[label={sec:orgaa19aab}]{Properties of HD spaces 3/3}
\begin{itemize}
...
\begin{frame}[label={sec:org4f1acfe}]{Consequences for the analysis}
\begin{itemize}
...
\end{frame}
\section{Questions}
\label{sec:org97ca70b}
\begin{frame}[label={sec:orgd125bdb}]{Is there a fake ?}
\begin{onlyenv}<1>
\begin{center}
...
\begin{frame}[label={sec:org00af0f9}]{Spectra}
...
\begin{frame}[label={sec:org694b0e4}]{Gaussian distribution}
