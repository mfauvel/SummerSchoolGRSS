...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga705e09}]{Classification overview}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8363084}]{Data sets used}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8847a3a}]{Confusion matrix 1/2}
\textbf{Confusion Matrix}: Compute the agreement between the classifier and the reference data.
  ...
  \centerline{\begin{tabular}{c|c|ccc|}
      ...
      \end{tabular}}
\end{frame}
\begin{frame}[label={sec:org32c3540}]{Confusion matrix 2/2}
...
$$F1_{i} = 2\frac{1}{1/{p^{tpr}_i} +1/{p^{ppv}_i}}$$
\end{itemize}
\end{frame}

\section{Introductory examples}
\label{sec:orga299a9e}
...
\label{sec:org375c41f}
\begin{frame}[fragile,label={sec:org6a09c7e}]{Experimental set-up}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
import scipy as sp
import rasterTools as rt
from sklearn.model_selection import train_test_split
...
\begin{frame}[label={sec:org33d06b1}]{Results}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:org968ffbc}
\begin{frame}[fragile,label={sec:org6034214}]{Experimental set-up}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orgbe1e0a7}]{Results}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7ca44a4}]{Classification Map}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.55\textwidth]{./figures/university_color.png}
...
\label{sec:org3ae38fe}
\begin{frame}[fragile,label={sec:org97d1004}]{PCA, LDA and KPCA}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
...
\label{sec:org7b79b43}
\subsection{Introduction}
\label{sec:orgfa54a27}
\begin{frame}[label={sec:orgfa09754}]{Overview of spatial-spectral methods}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgc1c72a7}]{Question to solve}
\begin{enumerate}
...
\label{sec:org03b54a4}
\begin{frame}[fragile,label={sec:org86c86b4}]{Texture information}
 \begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga81b1ee}]{Morphological neighborhood}
\begin{center}
...
\begin{frame}[label={sec:org6afe746}]{Morphological profile}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7b4bf53}]{Derivative of the MP}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfcbd16d}]{Limits of the (D)MP}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org40d0e59}]{Self-complementary area filter}
\begin{itemize}
...
\end{tabular}}
\end{frame}
\begin{frame}[label={sec:org9090151}]{MN based on area filtering}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org16657b4}]{Extended Morphological Profile}
...
\begin{frame}[fragile,label={sec:orga810c67}]{Application case: Extended Morphological Profile}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orgf98b703}]{Questions 1/2}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgfa54483}]{Questions 2/2}
...
\label{sec:org493507d}
\begin{frame}[label={sec:org9580aee}]{Feature fusion 1/2}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6948de6}]{Feature fusion 2/2}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge02c48c}]{Classifier fusion 1/2}
\begin{center}
  \tikzstyle{data} = [draw, ellipse,fill=red!20, node distance=3cm, minimum height=2em]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbd592bf}]{Classifier fusion 2/2}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:org6f64e91}]{Data fusion in action}
 \begin{itemize}
...
\label{sec:orgdf68859}
\begin{frame}[label={sec:org812d81d}]{Segmentation 1/4}
\begin{itemize}
\item Main ideas
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:org48706ac}]{Segmentation 2/4}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{bash}
# Using Mean Shift
...
\begin{frame}[fragile,label={sec:orgda6b2a6}]{Segmentation 3/4}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
import rasterTools as rt
import scipy as sp
...
\begin{frame}[label={sec:orgf61fc5a}]{Segmentation 4/4}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org709a145}]{Markov Random Field 1/2}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb96fde8}]{Markov Random Field 2/2}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:org343adcb}]{MRF in action 1/3}
 \begin{itemize}
\item ICM main loop:
\end{itemize}
\begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orgd6edb8f}]{MRF in action 2/3}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{block}{Asphalt}
\begin{center}
...
\begin{frame}[label={sec:orgf79364e}]{MRF in action 3/3}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{block}{Spectral only}
\begin{center}
...
\label{sec:org9bf64d9}
\begin{frame}[label={sec:orge48b42f}]{Operations on kernels}
\begin{itemize}
