...
\end{center}
\end{frame}
\begin{frame}[label={sec:org0b0bfb9}]{Classification overview}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8e502ae}]{Data sets used}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org8cd350b}
\begin{frame}[fragile,label={sec:orgc23cacb}]{Experimental set-up}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
import scipy as sp
import rasterTools as rt
from sklearn.model_selection import train_test_split
...
\begin{frame}[label={sec:orgf2c27f1}]{Results}
\begin{center}
  \begin{tikzpicture}
...
\label{sec:orgb1966f0}
\begin{frame}[fragile,label={sec:orgaa6c717}]{Experimental set-up}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:org3d69940}]{Results}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9380a70}]{Classification Map}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\includegraphics[width=0.55\textwidth]{./figures/university_color.png}
...
\label{sec:orgb601818}
\begin{frame}[fragile,label={sec:orgd930dfb}]{PCA, LDA and KPCA}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
...
\label{sec:orga83396d}
\subsection{Introduction}
\label{sec:orgdd96ebe}
\begin{frame}[label={sec:org6254da1}]{Overview of spatial-spectral methods}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5db2f1e}]{Question to solve}
\begin{enumerate}
...
\label{sec:orga99ed05}
\begin{frame}[fragile,label={sec:orgc03e031}]{Texture information}
 \begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgef749b4}]{Morphological neighborhood}
\begin{center}
...
\begin{frame}[label={sec:orgc27bc15}]{Morphological profile}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2d2bf14}]{Derivative of the MP}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org26e4230}]{Limits of the (D)MP}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org1f2d151}]{Self-complementary area filter}
\begin{itemize}
...
\end{tabular}}
\end{frame}
\begin{frame}[label={sec:org226cb8b}]{MN based on area filtering}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org079de55}]{Extended Morphological Profile}
...
\begin{frame}[fragile,label={sec:orgc2a68ed}]{Application case: Extended Morphological Profile}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:orgb108fa4}]{Questions 1/2}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga8c6d13}]{Questions 2/2}
...
\label{sec:orgb56fab0}
\begin{frame}[label={sec:org1601edc}]{Feature fusion 1/2}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org014c4b4}]{Feature fusion 2/2}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org16b1d72}]{Classifier fusion 1/2}
\begin{center}
  \tikzstyle{data} = [draw, ellipse,fill=red!20, node distance=3cm, minimum height=2em]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org13e550c}]{Classifier fusion 2/2}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:orge7321d4}
\begin{frame}[label={sec:org1f2bd7c}]{Segmentation 1/4}
\begin{itemize}
\item Main ideas
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:orgc34802d}]{Segmentation 2/4}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{bash}
# Using Mean Shift
...
\begin{frame}[fragile,label={sec:orgd53d1f3}]{Segmentation 3/4}
 \begin{minted}[fontsize=\footnotesize,obeytabs=true,tabsize=4,bgcolor=bg]{python}
import rasterTools as rt
import scipy as sp
